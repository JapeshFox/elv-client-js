...
class ChannelGetVaLUrls extends Utility {
  blueprint() {
    return {
  ...
  header() {
    return `Get VoD-as-Live (VaL) channel object sample URLs for offering ${this.args.offeringKey} in ${this.args.objectId}`;
  }
}

if(require.main === module) {
  Utility.cmdLineInvoke(ChannelGetVaLUrls);
} else {
  module.exports = ChannelGetVaLUrls;
}